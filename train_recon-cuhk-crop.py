...
def main():
    ...
    # prefix.
    endpoints, body_prefix = model.endpoints(images, is_training=True, num_class=700)
    ...
    images2 = tf.image.adjust_brightness(images,1.0)
    ...
    with tf.control_dependencies(tf.get_collection(tf.GraphKeys.UPDATE_OPS)):
        train_op = optimizer.minimize(tf.add(loss_mean,recLoss/(255.0*255.0)), global_step=global_step)
