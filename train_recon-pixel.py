...
from TensorBlur.tensorblur.gaussian import GaussianBlur
...
parser.add_argument(
    '--decay_start_iteration', default=2000, type=int,
...
def main():
    ...
    # prefix.
    endpoints, body_prefix = model.endpoints(images, is_training=True, num_class=751)
    ...
    #images2=tf.compat.v1.image.draw_bounding_boxes(images, box, name=None, colors=None)
