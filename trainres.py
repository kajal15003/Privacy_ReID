...
parser.add_argument(
    '--model_name', default='inception_resnet_model', choices=NET_CHOICES,
...
parser.add_argument(
    '--learning_rate', default=3e-6, type=common.positive_float,
...
def main():
    ...
    with tf.control_dependencies(tf.get_collection(tf.GraphKeys.UPDATE_OPS)):
        train_op = optimizer.minimize(tf.add(loss_mean,recLoss), global_step=global_step)
